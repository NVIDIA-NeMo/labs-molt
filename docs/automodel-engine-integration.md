...
during model construction. Molt retains neither the HF varlen-attention packing
kwargs nor an HF MoE training or scalar auxiliary-loss optimization branch.
