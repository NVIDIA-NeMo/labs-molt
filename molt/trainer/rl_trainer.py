...
class BaseRLTrainer:
    ...
    def broadcast_to_vllm(self) -> None:
        ...
        # KV handling lives in the TrainingActor override: it pauses and clears vLLM's
        # caches around the broadcast, so a request that straddled the update re-prefills
