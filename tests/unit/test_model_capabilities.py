...
import molt.models.base as base_module
...
def test_loaded_hf_fallback_configures_indexed_mask_packing(monkeypatch):
    ...
    monkeypatch.setattr(base_module, "_detect_moe_arch", lambda _model: False)
    monkeypatch.setattr(base_module, "_will_use_hf_model", lambda _path: True)
    monkeypatch.setattr(base_module, "_mtp_off_kwargs", lambda _path: {})
